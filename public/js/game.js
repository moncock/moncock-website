...
(function () {
    ...
    sandbagImages[0].rest.src = './images/sandbag_stage_0.png';
    sandbagImages[0].hit.src = './images/sandbag_stage_0_hit.png';
    sandbagImages[1].rest.src = './images/sandbag_stage_1.png';
    sandbagImages[1].hit.src = './images/sandbag_stage_1_hit.png';
    sandbagImages[2].rest.src = './images/sandbag_stage_2.png';
    sandbagImages[2].hit.src = './images/sandbag_stage_2_hit.png';
    sandbagImages[3].rest.src = './images/sandbag_stage_3.png';
    sandbagImages[3].hit.src = './images/sandbag_stage_3_hit.png';
    sandbagImages[4].rest.src = './images/sandbag_stage_4.png';
    sandbagImages[4].hit.src = './images/sandbag_stage_4_hit.png';
    sandbagImages[5].rest.src = './images/sandbag_stage_5.png';
    sandbagImages[5].hit.src = './images/sandbag_stage_5_hit.png';
